...
if __name__ == '__main__':
    # u1 = "TEXTCOLLBYfGiJUETHQ4hAcKSMd5zYpgqf1YRDhkmxHkhPWptrkoyz28wnI9V0aHeAuaKnak"
    # u2 = "TEXTCOLLBYfGiJUETHQ4hEcKSMd5zYpgqf1YRDhkmxHkhPWptrkoyz28wnI9V0aHeAuaKnak"
    # print(u1==u2)
    # print(md5(u1.encode()).hexdigest()==md5(u2.encode()).hexdigest())
    main()